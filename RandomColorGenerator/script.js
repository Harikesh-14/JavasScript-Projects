...
generateBtn.addEventListener("click", () => {
    ...
    colorCode.innerHTML = `${colorArray[randNum]}`
    colorCode.style.color = `${colorArray[randNum]}`

    colorHex.style.borderColor = `${colorArray[randNum]}`

    colorBox.style.backgroundColor = `${colorArray[randNum]}`
})